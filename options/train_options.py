...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--lr_policy', type=str, default='multistep', help='learning rate policy. [linear | multistep | step | plateau | cosine]')
        parser.add_argument('--lr_decay_iters', type=int, default=50, help='multiply by a gamma every lr_decay_iters iterations')

        #方差对比
        parser.add_argument('--local_variance', action='store_true', help='if use local_variance')

        parser.add_argument('--ipdb', type=int, default=0, help='number of epochs with the initial learning rate')
        
        #LLM
        parser.add_argument('--fine_tune', action='store_true', help='if use local_variance')
